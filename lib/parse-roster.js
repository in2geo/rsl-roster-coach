...
Ignore Common (grey) and Uncommon (green) cards entirely.

For each Rare/Epic/Legendary/Mythical card:
- Record rarity, level, stars, index (0-based, left-to-right top-to-bottom)
- Read the name text on the card and match it to 1-3 slugs from the list below
- If the text is unclear, use the portrait appearance to pick the closest slug(s)
