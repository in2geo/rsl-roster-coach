 ...
 */
export function constructTeam(roster = [], needs = [], { contentKey, size = 5, eligible = () => true, tagMeta = {}, accFloor = null, qualityFn = null } = {}) {
  const opts = { contentKey, tagMeta, accFloor, qualityFn }; // built team scored at CURRENT reliability
