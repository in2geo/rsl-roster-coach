...
export const CB_NEEDS = [
  ...
  { phase: 'single', role: 'sustain', weight: 1.0,
    description: 'Keep the team alive — heals / shields / revive to survive Gathering Fury and bank damage',
    solutions: [['Continuous Heal'], ['AoE Heal'], ['Healer'], ['Shield'], ['AoE Shield'], ['Revive'], ['Revive on Death'], ['Ally Protection']] },
