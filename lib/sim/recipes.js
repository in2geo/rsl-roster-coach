...
export const RECIPES = {
  ...
  'RENEGADE-A2': {
    ...
    // Placement modelled once per activation (the engine's after_hit convention); the per-hit multiplicity is
    // entangled with the random-target nuance below and is credited when that clause is built.
    deferred: ['"at random 3 times" — random target per hit (targeting nuance)'],
  },
