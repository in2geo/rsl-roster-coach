...
export const RECIPES = {
  ...
  'PELOPS-PASSIVE': {
    ...
    deferred: ['50% [Petrification] on attacker', 'chances drop to 50%/25% while under [Decrease DEF]'],
  },
  ...
  'TAGOAR-A2': {
    ...
    deferred: ['[Increase SPD] buff placed; the DAMAGE consumer is built, but its TURN-ORDER effect (SPD in the scheduler) is not'],
  },
