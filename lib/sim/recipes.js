...
export const RECIPES = {
  ...
  'BAMBUS-A1': {
    ...
    actions: [
      ...
      { seq: 40, phase: 'after_skill', op: 'PLACE_DEBUFF', target: 'self', repeat: 'once',
        effect: { type: 'Sleep', duration: 1, chance: 1.0, accuracy_check: false } },   // Sleeping Sage self-Sleep
    ],
    deferred: [],
  },
  ...
  'EZIO-A3': {
    ...
    deferred: ['buff-steal unresistable under [Veil]/[Perfect Veil] — conditional (II-D)', 'also ignores [Strengthen] buffs ([Shield] ignore now built; [Strengthen] not modelled)'],
  },
  ...
  'PELOPS-PASSIVE': {
    ...
    deferred: ['"once per enemy skill" — re-fires per hit on a multi-hit skill (non-stacking, so outcome-immaterial; RNG land-rate nuance)'],
  },
