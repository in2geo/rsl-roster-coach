...
export const RECIPES = {
  ...
  'UUGO-PASSIVE': {
    ...
    deferred: ['places 30% [Increase SPD] + [Block Damage] on self when her LAST living ally is killed — ON_ALLY_DEATH_REACTIVE trigger (fires on ally death) not built; both buffs have consumers but cannot fire without the trigger'],
  },
