    ...
    actEnemy(state, boss) {
      ...
      if (scorchArmed) {
        ...
        if (purpleBarHp == null && mode !== 'always') {
          ...
          for (const a of allies) { dealDamage(a, bossHit(boss, a), 'direct', boss, state.allies); applyDebuff(a, { type: 'Stun', turns: 1 }); }
          ...
          for (const a of allies) {
            dealDamage(a, bossHit(boss, a), 'direct', boss, state.allies);
