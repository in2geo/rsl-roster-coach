  ...
  if (skill.hitsEnemies) {
    ...
    for (const t of targets) {
      if (skill.maxHpPct != null) {
        ...
        // on-hit reactive passives (Second Wind, Master-of-Games) — the non-recipe-mob mirror of the recipe
        // path's dealOneHit. Hooked to avoid a circular import; no-op unless installRecipeRun wired it.
        state.onDamageTaken?.(state, t, actor, dd.toHp);
      }
